...
describe('model-gateway router', () => {
  ...
  it('routes xingtuo providers to openai-compat for llm usage', () => {
    expect(isCompatibleProvider('xingtuo')).toBe(true)
    expect(resolveModelGatewayRoute('xingtuo')).toBe('openai-compat')
  })
