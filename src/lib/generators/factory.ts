...
import { Sub2ApiImageGenerator } from './sub2api'
import {
...
import { ThirdpartyVeoVideoGenerator } from './thirdparty-veo'
...
export function createImageGenerator(provider: string, modelId?: string): ImageGenerator {
    ...
    switch (providerKey) {
        ...
        case 'sub2api':
        case 'xingtuo':
            return new Sub2ApiImageGenerator()
...
export function createVideoGenerator(provider: string): VideoGenerator {
    ...
    switch (providerKey) {
        ...
        case 'thirdparty-veo':
            return new ThirdpartyVeoVideoGenerator()
        case 'openai-compatible':
