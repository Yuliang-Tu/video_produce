...
export const PRESET_MODELS: PresetModel[] = [
    ...
    { modelId: 'gpt-5.5', name: 'GPT-5.5 (Sub2API)', type: 'llm', provider: 'sub2api', llmProtocol: 'chat-completions' },
    { modelId: 'gpt-5.5', name: 'GPT-5.5 (星拓)', type: 'llm', provider: 'xingtuo', llmProtocol: 'chat-completions' },

    // 图像模型
    { modelId: 'gpt-image-2', name: 'GPT Image 2 (星拓)', type: 'image', provider: 'xingtuo' },
    ...
    { modelId: 'veo_3_1', name: 'Third-party Veo 3.1', type: 'video', provider: 'thirdparty-veo' },
    { modelId: 'veo_3_1-hd', name: 'Third-party Veo 3.1 HD', type: 'video', provider: 'thirdparty-veo' },
    { modelId: 'veo_3_1-fast-hd', name: 'Third-party Veo 3.1 Fast HD', type: 'video', provider: 'thirdparty-veo' },
    { modelId: 'veo_3_1-fl', name: 'Third-party Veo 3.1 FL', type: 'video', provider: 'thirdparty-veo' },
    { modelId: 'veo_3_1-fast-fl', name: 'Third-party Veo 3.1 Fast FL', type: 'video', provider: 'thirdparty-veo' },
    { modelId: 'veo_3_1-fast-fl-hd', name: 'Third-party Veo 3.1 Fast FL HD', type: 'video', provider: 'thirdparty-veo' },
    { modelId: 'veo_3_1-hd-fl', name: 'Third-party Veo 3.1 HD FL', type: 'video', provider: 'thirdparty-veo' },
    // 阿里云百炼图生视频模型
...
export const PRESET_PROVIDERS: Omit<Provider, 'apiKey' | 'hasApiKey'>[] = [
    ...
    { id: 'vidu', name: 'Vidu' },
    { id: 'fal', name: 'FAL' },
    { id: 'thirdparty-veo', name: 'Third-party Veo' },
    { id: 'sub2api', name: 'Sub2API', baseUrl: 'http://121.127.253.220:8080', gatewayRoute: 'openai-compat' },
    { id: 'xingtuo', name: '星拓', baseUrl: 'http://121.127.253.220:8090/v1' },
]
