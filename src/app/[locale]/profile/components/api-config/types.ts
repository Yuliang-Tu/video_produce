...
export const PRESET_MODELS: PresetModel[] = [
    ...
    { modelId: 'veo_3_1-fast', name: 'Third-party Veo 3.1 Fast', type: 'video', provider: 'thirdparty-veo' },
    { modelId: 'veo_3_1-fast-fl', name: 'Third-party Veo 3.1 Fast FL', type: 'video', provider: 'thirdparty-veo' },
    { modelId: 'veo_3_1-fast-remix', name: 'Third-party Veo 3.1 Fast 15s', type: 'video', provider: 'thirdparty-veo' },
    { modelId: 'veo_3_1-fast-fl-remix', name: 'Third-party Veo 3.1 Fast FL 15s', type: 'video', provider: 'thirdparty-veo' },
    // 阿里云百炼图生视频模型
